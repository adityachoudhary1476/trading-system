...
def detect_task_type(task_description: str,
    ...
    backend_kw = ("backend", "python", "api", "pytest", "trading_system",
    ...
    # Docs takes priority: a task explicitly about documentation/research
    # should not be classified as a backend implementation task even if it
    # mentions backend keywords (e.g. "docs for the API").
    if is_docs and not is_frontend:
        return "docs"
